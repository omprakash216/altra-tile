...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['action'])) {
        ...
        if ($action == 'delete') {
            ...
            try {
                ...
                $stmt = $connection->prepare("DELETE FROM tbl_sobha_inquary WHERE id = ?");
    ...
    header('Location: sobha_inquiries.php');
    exit();
}
...
try {
    ...
    $query = "SELECT * FROM tbl_sobha_inquary $where_clause ORDER BY created_at DESC";
...
try {
    $total_count = $connection->query("SELECT COUNT(*) as count FROM tbl_sobha_inquary")->fetch_assoc()['count'];
    $today_count = $connection->query("SELECT COUNT(*) as count FROM tbl_sobha_inquary WHERE DATE(created_at) = CURDATE()")->fetch_assoc()['count'];
    $week_count = $connection->query("SELECT COUNT(*) as count FROM tbl_sobha_inquary WHERE created_at >= DATE_SUB(NOW(), INTERVAL 7 DAY)")->fetch_assoc()['count'];
    $month_count = $connection->query("SELECT COUNT(*) as count FROM tbl_sobha_inquary WHERE created_at >= DATE_SUB(NOW(), INTERVAL 30 DAY)")->fetch_assoc()['count'];
} catch(Exception $e) {
...
<head>
    ...
    <title>SOBHA Inquiries - Vanaya Spaces Admin</title>
...
<body class="bg-light">
    <?php include 'sidebar.php'; ?>
                ...
                <div class="page-header-modern">
                    <h1><i class="fas fa-building me-2"></i>SOBHA Inquiries</h1>
                </div>
                        ...
                        <form method="GET" class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2">
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="sobha_inquiries.php" class="btn btn-outline-secondary btn-modern">
    ...
    <script>
        ...
        function sendEmail(email, name) {
            const subject = 'Regarding Your SOBHA Inquiry';
            const body = `Dear ${name},\n\nThank you for your inquiry about SOBHA. We will get back to you soon.\n\nBest regards,\nVanaya Spaces Team`;
